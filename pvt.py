...
class PolypPVT(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('pvt shape',[o.shape for o in pvt])
        # print("x1 shape:", x1.shape)
        # print("CIM feature shape:", cim_feature.shape)
        #
        # print("x2t shape:", x2_t.shape)
        # print("x3t shape:", x3_t.shape)
        # print("x4t shape:", x4_t.shape)
        # print("CFM feature shape:", cfm_feature.shape)
        #
        # print("T2 shape:", T2.shape)
        # print("SAM feature shape:", sam_feature.shape)
        #
        # print("prediction1 shape:", prediction1.shape)
        # print("prediction2 shape:", prediction2.shape)
        #
        #
        # print("prediction18 shape:", prediction1_8.shape)
        # print("prediction28 shape:", prediction2_8.shape)
